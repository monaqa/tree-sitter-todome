...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__comment_line, 2),
  [84] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__comment_line, 2),
