...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__due_inner, 1, .production_id = 8),
  ...
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__due_inner, 2, .production_id = 13),
  ...
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__due_inner, 3, .production_id = 20),
  ...
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__due_inner, 2, .production_id = 14),
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__due_inner, 4, .production_id = 22),
  [244] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [246] = {.entry = {.count = 1, .reusable = true}}, SHIFT(65),
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__due_inner, 6, .production_id = 24),
  [250] = {.entry = {.count = 1, .reusable = false}}, SHIFT(63),
  [252] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [254] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__due_inner, 4, .production_id = 21),
