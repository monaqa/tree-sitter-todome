...
module.exports = grammar({
  ...
  conflicts: ($) => [[$._task_line, $._header_line]],
  ...
  rules: {
    ...
    task: ($) =>
      seq(
        $._task_line,
        choice(seq($._indent, field("children", $.block)), $._newline),
      ),
    ...
    block: ($) =>
      seq(repeat(choice($.task, $.header, $._memo_line)), $._dedent),
    ...
    _header_line: ($) =>
      choice(
        ...
        seq(field("status", $.status), optional($.memo)),
      ),
